...
".$RezervimId;
  ...
  <body>
    <div class="modal-dialog">
      <form action="backend/backend.editreservation.php" method="POST">
        ...
        while ($row1=mysqli_fetch_array($result1, MYSQLI_BOTH)) {
            ...
            <!-- Butoni -->
            <div class="form-group">
              <input type="submit" class="btn btn-block btn-lg btn-primary" name="rezervo" value="Modifiko Rezervim" />
            </div>
